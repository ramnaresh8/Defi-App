                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Gather requirements, define features, and determine
                      project timeline.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Create wireframes and design user-friendly interface for
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Implement wallet connectivity, token swapping
                      functionality, and real-time price visualization.
                    </span>
                  </Fragment>
                )}
              </span>
